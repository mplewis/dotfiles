# Generated by Powerlevel10k configuration wizard on 2022-09-21 at 11:50 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_HUGO_PROMPT_ALWAYS_SHOW=false
  typeset -g POWERLEVEL9K_ASDF_REDIS_PROMPT_ALWAYS_SHOW=false
  ...
  typeset -g POWERLEVEL9K_ASDF_PYTHON_SHOW_ON_UPGLOB='*.py|requirements.txt'
